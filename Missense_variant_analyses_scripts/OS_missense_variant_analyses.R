...
# Prerequisites:
# 1) Run script GL_missense_variant_analyses.R
...
###############################################################################
## Importing covariate file including all required covariates and mismatch sums
...
################################################################################
### The survival analysis: the mismatch sum association to overall survival 
### event
...
## Analyzing the quartiles of the mismatch data in all missense variants
...
################################################################################
### Performing multiple test corrections for OS for mismatch sum and quartiles
## Mm sums
