...
# Creating a new column from quartiles (1 = the lowest quartile, 2 = the second, 
...
## Writing out the "R_cov_mm_liver" with calculated quartiles for each protein
# group
...
################################################################################
### Performing multiple test corrections for AR for mismatch sum and quartiles
## Mm sums
