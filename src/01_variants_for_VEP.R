...
### Prerequisites:
# 1) Your genotype file in PLINK format (.bed, .bim, .fam) in data folder

################################################################################
# Import corresponding PLINK bim file
Liver_Tx_cohort <- read_table2("data/Liver_Tx_cohort_info_0_6_chr_1_23.bim", 
                               col_names = F)
...
write.table(Liver_Tx_cohort, "results/Variables_for_VEP",
